...
class StudentProfileForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields=['surname','othernames','matric_number','directorate', 'department','program_of_study','study_mode','state_of_origin','profile_pic','id_card','student_file','student_reciept']
        widgets={
            ...
            'student_reciept':forms.FileInput(attrs={'class':'form-control'}),
        }
